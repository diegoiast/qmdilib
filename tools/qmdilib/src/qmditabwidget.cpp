 ...
 *
 * This class has also another improvement over QTabWidget: when the number of tabs is less then
 * 2 (one tab is open, or none) the tab bar will not be displayed. (This is new in version 0.0.5)
 * 
 * The relations are:
 ...
 * 
 * This function will also hide the tabbar, if the number of tabs is less then 2.
 *
